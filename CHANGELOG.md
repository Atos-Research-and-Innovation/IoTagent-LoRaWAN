...
-   Upgrade server to allow multi-core execution based on the changes introduced in iotagent-node-lib from X to Y.
    Including a mention to configure multithreading using cluster nodejs module (through multiCore config.js parameter
    or IOTA_MULTI_CORE environment variable).
