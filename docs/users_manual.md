...
2. Follow the [Getting started](https://www.loraserver.io/use/getting-started/) page to register your network-server and to create a service-profile, gateway, device-profile, application. Finally, add your LoRaWAN devices.
Register your network-server: https://www.loraserver.io/lora-app-server/use/network-servers/
4. In order to use FIWARE IoT Agent for LoRaWAN protocol, you will need the following information:
  - Application ID
  - Application key
  - Device EUI
